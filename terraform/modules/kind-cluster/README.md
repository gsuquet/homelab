...
| <a name="input_kube_proxy_mode"></a> [kube\_proxy\_mode](#input\_kube\_proxy\_mode) | Kube-proxy mode ('iptables', 'ipvs', or 'none'). Set to 'none' when using Cilium in kube-proxy replacement mode. | `string` | `"none"` | no |
